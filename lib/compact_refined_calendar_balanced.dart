...
import 'package:prvin/task_management_demo.dart';

void main() {
  runApp(const CompactRefinedCalendarApp());
}

/// 紧凑精美日历应用 - 平衡版本（性能与视觉效果并重）
...
class _CompactRefinedCalendarPageState extends State<CompactRefinedCalendarPage>
  ...
  void initState() {
    ...
    _scaleController = AnimationController(
      duration: const Duration(milliseconds: 150), // 快速缩放动画
      vsync: this,
    );
    _slideController = AnimationController(
      duration: const Duration(milliseconds: 300), // 月份切换动画
      vsync: this,
    );
    ...
    Navigator.of(context).push(
      PageRouteBuilder<void>(
        pageBuilder: (context, animation, secondaryAnimation) {
          return const TaskManagementDemoApp();
        },
