...
/// Overlay管理的任务创建器
/// 使用Overlay直接管理浮层显示，避免与Dialog的层级冲突
  ...
  static void show(
    ...
    _overlayEntry = OverlayEntry(
      builder: (context) => BlocProvider.value(
        value: taskBloc,
        child: _OverlayTaskWidget(initialDate: initialDate, onClose: hide),
      ),
    );
...
class _OverlayTaskWidget extends StatefulWidget {
  ...
  @override
  State<_OverlayTaskWidget> createState() => _OverlayTaskWidgetState();
}

class _OverlayTaskWidgetState extends State<_OverlayTaskWidget>
    ...
    return MultiBlocListener(
      ...
      child: Material(
        ...
        child: Container(
          ...
          color: Colors.black.withOpacity(0.3), // 背景遮罩
          child: Align(
