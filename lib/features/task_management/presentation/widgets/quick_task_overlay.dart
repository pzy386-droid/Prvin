...
class QuickTaskOverlay extends StatefulWidget {
  ...
  @override
  State<QuickTaskOverlay> createState() => _QuickTaskOverlayState();
}

class _QuickTaskOverlayState extends State<QuickTaskOverlay>
  ...
  void initState() {
    ...
    _slideAnimation =
        Tween<Offset>(
          begin: const Offset(1.2, 1.2), // 从右下角外部开始
          end: Offset.zero,
        ).animate(
          CurvedAnimation(
            parent: _slideController,
            curve: Curves.easeOutCubic, // 苹果风格的缓动曲线
          ),
        );
      ...
      listeners: [
        ...
        BlocListener<TaskBloc, TaskState>(
          ...
          listener: (context, state) {
            _closeWithAnimation(); // 只关闭弹窗，不显示成功消息
          },
        ),
        // 监听错误状态
        BlocListener<TaskBloc, TaskState>(
